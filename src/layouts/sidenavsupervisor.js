...
export default function Sidenavsupervisor(){
    ...
    <Link to='/supervisor/home'><div className="menusb"><i class="fas fa-blog"></i><span>Topic Status</span></div></Link>
    <Link to='/supervisor/home'><div className="menusb"><i class="fas fa-comment"></i><span>Chat With Groups</span></div></Link>
    <Link to='/supervisor/home'><div className="menusb"><i class="fas fa-edit"></i><span>Evaluate</span></div></Link>
</div>
  </>
    )
}